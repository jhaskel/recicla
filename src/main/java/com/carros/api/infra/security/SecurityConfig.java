...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.cors().configurationSource(request -> new CorsConfiguration().applyPermitDefaultValues())
                ...
                .permitAll()
                .antMatchers(HttpMethod.POST, "/api/v1/usuarios","/api/v1/parceiro","/email")
                .permitAll()
                .antMatchers(HttpMethod.PUT,"/api/v1/usuarios/{$id}","/api/v1/parceiro/{$id}")
                .permitAll()
                .antMatchers(HttpMethod.DELETE,"/api/v1/cidades/{$id}")
                .permitAll()
                .antMatchers(HttpMethod.DELETE,"/v2/api-docs", "/configuration/**", "/swagger*/**", "/webjars/**")
                .permitAll()
